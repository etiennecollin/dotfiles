...
yay -Syuq --needed bat bind blender bottom-git brave-bin brave-browser calf calibre celluloid coolercontrol discord discord easyeffects ethtool eza fail2ban fastfetch fd ffmpegthumbnailer freecad fzf gamemode git-delta github-cli gnupg graphviz hakuneko-desktop-bin hexyl htop jq kicad lazydocker lazygit libreoffice-fresh lsp-plugins man-db man-pages neovim noto-fonts ntfs-3g nvtop oh-my-posh openssh openssl os-prober pandoc-cli parallel poetry poppler python ripgrep rustup sed silicon sioyek steam sudo testdisk tlrc tmux transmission-gtk tree ttf-jetbrains-mono-nerd typst udiskie ufw unarchiver unzip via-bin wezterm wget xclip xdg-ninja-git xdg-user-dirs xdg-utils yazi yubico-authenticator-bin yubikey-manager-qt zellij zip zoxide zsh
